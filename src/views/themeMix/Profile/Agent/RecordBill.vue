  ...
  .profile_record
    .profile_record-head
      .date-row
        ...
        .time-type(v-if="mainTypeValue != 1") 时选方式：
      ...
      div.mb10
        label 会员账号：
          Input.form-width.mr10(type="text" v-model="query.userName" placeholder="下级交易查询" @on-change="resetCurrent()")
      div
        label.mr15 主类：

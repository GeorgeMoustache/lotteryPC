  ...
  .profile_record
    ...
    .agent-wrap
      .profile_record-head
        ...
        div
          Input.form-width.mr10(v-model="query.userName" placeholder="下级报表查询")
          Checkbox.ml10.mr10(v-model="query.itself" true-value="1" false-value="0") 包含代理自身数据
          Button(type="info" icon="ios-search" @click="fetchData" :loading="submiting") 点击查询
